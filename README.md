...
*  **Пароль на повторную пересдачу** Блокировка повторой пересдачи с этого компьютера если уже успешна тест сдан. Блокировка повторой пересдачи уже сданного теста если ФИО есть в базе данных по этому тесту.
