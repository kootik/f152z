...
class GradeSchema(BaseModel):
    ...
    number: int
    text: str
    class_name: str = Field(..., alias="class") # Используем alias, т.к. "class" - ключевое слово
...
class SaveResultsRequest(BaseModel):
    ...
    behavioralMetrics: Optional[BehavioralMetrics] = Field(default_factory=BehavioralMetrics)
    model_config = ConfigDict(
